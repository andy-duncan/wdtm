...
describe('wdtm', function () {
  describe('text', function () {
    ...
    describe('quadrillions', () => {
      it('one quadrillion', () => {
        assert.equal(text('1000000000000000'), 'one quadrillion');
      });

      it('one quadrillion and twenty three', () => {
        assert.equal(text('1000000000000023'), 'one quadrillion and twenty three');
      });

      it('forty seven quadrillion two hundred and eighty', () => {
        assert.equal(text('47000000000000280'), 'forty seven quadrillion two hundred and eighty');
      });

      it('two quadrillion four hundred trillion four hundred billion four hundred million four hundred thousand four hundred', () => {
        assert.equal(text('2400400400400400'), 'two quadrillion four hundred trillion four hundred billion four hundred million four hundred thousand four hundred');
      });

      it('thirty two quadrillion four hundred thousand three hundred', () => {
        assert.equal(text('32000000000400300'), 'thirty two quadrillion four hundred thousand three hundred');
      });

      it('two quadrillion four hundred trillion three hundred and eleven', () => {
        assert.equal(text('2400000000000311'), 'two quadrillion four hundred trillion three hundred and eleven');
      });

      it('four quadrillion two hundred and twelve million', () => {
        assert.equal(text('4000000212000000'), 'four quadrillion two hundred and twelve million');
      });

      it('four hundred and twenty three quadrillion one hundred and twenty two thousand five hundred ', () => {
        assert.equal(text('423000000000122500'), 'four hundred and twenty three quadrillion one hundred and twenty two thousand five hundred');
      });

      it('four hundred and twenty three quadrillion sixty six trillion three billion nine hundred million one hundred and twenty two thousand and sixty nine', () => {
        assert.equal(text('423066003900122069'), 'four hundred and twenty three quadrillion sixty six trillion three billion nine hundred million one hundred and twenty two thousand and sixty nine');
      });
    });
  });
});